...
int main(int argc, char **argv)
{
   ...
   std::map<std::string, void (World::ScreenFactory::*)()> screen_elements = {
      //{ "TITLE_SCREEN", World::ScreenFactory::
   };

   World::BasicScreens::Factory basic_screen_factory(display); // here, we'll just use the basic factory to make some generic screens

   World::ScreenManager *screen_manager = new World::ScreenManager(framework, screens, music_track_elements, sound_effect_elements, &basic_screen_factory);
