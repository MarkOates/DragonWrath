...
TrackPlayerDragonThenFreeze::TrackPlayerDragonThenFreeze(DragonWrath::Entities::Base *entity, float speed)
...
TrackPlayerDragonThenFreeze::~TrackPlayerDragonThenFreeze()
{
}


void TrackPlayerDragonThenFreeze::initialize()
{
   if (entity)
   {
...
void TrackPlayerDragonThenFreeze::update()
{
   timer += 1.0/60.0f;
   ...
   if (entity)
   {
      ...
      else
      {
         ...
         error_message << "TrackPlayerDragonThenFreeze::update(): error: root is unexpectedly nullptr" << std::endl;
